...
import com.ruoyi.web.service.impl.SysDeptServiceImpl;
import com.ruoyi.web.service.impl.SysPostServiceImpl;
import com.ruoyi.web.service.impl.SysRoleServiceImpl;
...
//    public void export(HttpServletResponse response, SysUser user) {
    public void export(Response response, SysUser user) {
        List<SysUser> list = userService.selectUserList(user);
...
//    public AjaxResult importData(MultipartFile file, boolean updateSupport) throws Exception
    public AjaxResult importData(UploadedFile file, boolean updateSupport) throws Exception {
        ExcelUtil<SysUser> util = new ExcelUtil<SysUser>(SysUser.class);
//        List<SysUser> userList = util.importExcel(file.getInputStream());
        List<SysUser> userList = util.importExcel(file.getContent());
...
//    public void importTemplate(HttpServletResponse response)
    public void importTemplate(Response response) {
        ExcelUtil<SysUser> util = new ExcelUtil<SysUser>(SysUser.class);
